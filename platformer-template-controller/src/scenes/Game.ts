...
export default class Game extends Phaser.Scene
{
	...
	//variable de pinguino que se usa para el persobaje principal
	//como es unico alcanza con una asignacion directa
	private penquin?: Phaser.Physics.Matter.Sprite
	
	//controladores: manejadores de los objectos.
	...
	init()
	{
		// inicia los valores necesarios
		// cursores, obstaculos y array de muñecos de nieve
